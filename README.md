...
- **🤖 Smart SMS Parsing** — <!-- BANKS_SUMMARY -->156 banks across 24 countries<!-- /BANKS_SUMMARY --> with real-time detection of incoming SMS
...
Supporting **156 banks & services** across **24 countries** with **multi-currency** capabilities:
