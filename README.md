...
- **🤖 Smart SMS Parsing** — <!-- BANKS_SUMMARY -->130 banks across 22 countries<!-- /BANKS_SUMMARY --> with real-time detection of incoming SMS
...
Supporting **130 banks & services** across **22 countries** with **multi-currency** capabilities:
