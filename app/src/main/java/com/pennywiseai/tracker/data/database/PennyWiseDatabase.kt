...
// Migration 40→41: AutoMigration adds `profile_id` (default 1) to `account_balances`. No spec needed.
// Migration 41→42: AutoMigration adds nullable `profile_id` to `transactions`. No spec needed.
