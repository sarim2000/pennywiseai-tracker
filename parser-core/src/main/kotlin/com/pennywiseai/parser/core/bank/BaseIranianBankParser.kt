...
abstract class BaseIranianBankParser : BankParser() {
    ...
    override fun extractAmount(message: String): BigDecimal? {
        // Parse amounts using the common regex pattern for Iranian banks
    ...
    override fun extractTransactionType(message: String): TransactionType? {
        ...
        return when {
            ...
            // Income keywords in Persian - FIXED: Avoid "+" false positive by being more specific
    ...
    override fun extractMerchant(message: String, sender: String): String? {
        // Iranian banks don't typically include merchant names in SMS
    ...
    override fun extractReference(message: String): String? {
        // Iranian bank messages don't typically have reference numbers
        return null
    }
    ...
    override fun extractBalance(message: String): BigDecimal? {
        ...
        balancePattern.find(message)?.let { match ->
            ...
            return try {
                ...
                null // FIXED: Return null instead of BigDecimal.ZERO
            }
        }

        return null // FIXED: Return null instead of BigDecimal.ZERO
    }
