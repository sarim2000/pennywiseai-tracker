...
- **🤖 Smart SMS Parsing** — <!-- BANKS_SUMMARY -->136 banks across 22 countries<!-- /BANKS_SUMMARY --> with real-time detection of incoming SMS
...
Supporting **136 banks & services** across **22 countries** with **multi-currency** capabilities:
