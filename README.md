...
- **🤖 Smart SMS Parsing** — <!-- BANKS_SUMMARY -->145 banks across 23 countries<!-- /BANKS_SUMMARY --> with real-time detection of incoming SMS
...
Supporting **145 banks & services** across **23 countries** with **multi-currency** capabilities:
...
### 🇪🇹 Ethiopia — ETB ብር (5)
**Bank of Abyssinia**, **Commercial Bank of Ethiopia**, **Dashen Bank**, **Telebirr**, **Zemen Bank**
