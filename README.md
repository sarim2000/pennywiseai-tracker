...
- **🤖 Smart SMS Parsing** — <!-- BANKS_SUMMARY -->146 banks across 23 countries<!-- /BANKS_SUMMARY --> with real-time detection of incoming SMS
...
Supporting **146 banks & services** across **23 countries** with **multi-currency** capabilities:
...
### 🇪🇹 Ethiopia — ETB ብር (6)
**Bank of Abyssinia**, **Commercial Bank of Ethiopia**, **Dashen Bank**, **Telebirr**, **ZamZam Bank**, **Zemen Bank**
