    ...
    fun `reported messages parse correctly`(): List<DynamicTest> {
        val cases = listOf(
            ...
            SimpleTestCase(
                ...
                sender = "TX-MYAMEX-S",
                currency = "INR",
                message = "Your Amex SafeKey One-Time Password for INR 213.50, at X CORP- PAID FEATURES is 282457. Valid for 10 mins for Card ending  01003. Do not disclose it to anyone.",
                shouldParse = false
            ),
            SimpleTestCase(
                ...
                sender = "VM-KOTAKB-S",
                currency = "INR",
                message = "Payment of INR 1577 on Kotak Credit Card xx0387 is due on 13-07-26. Min due: INR 100. Tap to pay: https://gs.im/KOTAKB/e/Ygczup Ignore if paid",
                shouldParse = false
            ),
            SimpleTestCase(
            ...
            SimpleTestCase(
                ...
                sender = "TX-HDFCBK-S",
                currency = "INR",
                message = "Dear Customer, You have received Amazon Shopping E-voucher Rs.500/- from HDFC Bank My Rewards Redemption programme. Your E-Voucher [E-Voucher Code is XXXX-XXXXXX-XXX, Pin: , Valid till 02-Aug-2027 Value : INR 500.00] . For more details call 18002586050. HDFC Bank",
                shouldParse = false
            ),
            ...
            SimpleTestCase(
                ...
                sender = "JM-ICICIT-S",
                currency = "INR",
                message = "USD .28 spent using ICICI Bank Card XX8003 on 01-Jun-26 on GOOGLE*CLOUD PH. Avl Limit: INR 3,85,664.53. If not you, call 1800 2662/SMS BLOCK 8003 to 9215676766.",
            ...
            SimpleTestCase(
                ...
                sender = "VM-BOBTXN-S",
                currency = "INR",
                message = "Rs..6 Credited to A/c ...4040 from:ACHCR/JIO FINANC. Total Bal:Rs.22976.31CR. Avlbl Amt:Rs.22976.31(26-08-2026 18:20:36) - Bank of Baroda",
                expected = ExpectedTransaction(
            ...
            SimpleTestCase(
                ...
                sender = "JX-CUBANK-S",
                currency = "INR",
                message = "Your a/c no. XXXXXXXX5501 is credited for Rs.5000.00 on 03-05-2026 and debited from a/c no. XXXXXXXX4577 (UPI Ref no 612304540358) -CUB",
                expected = ExpectedTransaction(
