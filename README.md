...
- **🤖 Smart SMS Parsing** — <!-- BANKS_SUMMARY -->150 banks across 23 countries<!-- /BANKS_SUMMARY --> with real-time detection of incoming SMS
...
Supporting **150 banks & services** across **23 countries** with **multi-currency** capabilities:
