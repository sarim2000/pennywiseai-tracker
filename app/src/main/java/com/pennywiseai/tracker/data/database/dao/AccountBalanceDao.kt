...
interface AccountBalanceDao {
    ...
    @Query("UPDATE account_balances SET is_business = :isBusiness WHERE bank_name = :bankName AND account_last4 = :accountLast4")
    suspend fun setAccountBusiness(bankName: String, accountLast4: String, isBusiness: Boolean): Int
}