...
- **🤖 Smart SMS Parsing** — <!-- BANKS_SUMMARY -->147 banks across 23 countries<!-- /BANKS_SUMMARY --> with real-time detection of incoming SMS
...
Supporting **147 banks & services** across **23 countries** with **multi-currency** capabilities:
...
### 🇳🇬 Nigeria — NGN ₦ (8)
**Access Bank**, **GTBank**, **Jaiz Bank**, **Keystone Bank**, **Opay**, **Standard Chartered Bank Nigeria**, **VFD Microfinance Bank**, **Zenith Bank**
