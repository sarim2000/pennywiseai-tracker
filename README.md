...
- **🤖 Smart SMS Parsing** — <!-- BANKS_SUMMARY -->149 banks across 23 countries<!-- /BANKS_SUMMARY --> with real-time detection of incoming SMS
...
Supporting **149 banks & services** across **23 countries** with **multi-currency** capabilities:
...
### 🇪🇹 Ethiopia — ETB ብር (8)
**Awash Bank**, **Bank of Abyssinia**, **Commercial Bank of Ethiopia**, **Dashen Bank**, **Siket Bank**, **Telebirr**, **ZamZam Bank**, **Zemen Bank**
...
### 🇳🇬 Nigeria — NGN ₦ (6)
**Access Bank**, **Jaiz Bank**, **Keystone Bank**, **Moniepoint**, **Opay**, **Zenith Bank**
