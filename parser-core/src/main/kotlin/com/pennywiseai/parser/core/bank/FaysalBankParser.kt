 ...
 * "PKR 55.000.00 sent to AZWAR HABIB A/C *9901 via IBFT from FBL A/C *4647 on 06-FEB-2026 02:22 PM Ref # 960855."
 */
class FaysalBankParser : BankParser() {
    ...
    override fun canHandle(sender: String): Boolean {
        ...
        val isShortCode = normalized == "8756"
    ...
    override fun extractAccountLast4(message: String): String? {
        ...
        for (pattern in patterns) {
            ...
            if (matches.isNotEmpty()) {
                // Prefer the last occurrence (typically the receiver account)
    ...
    override fun detectIsCard(message: String): Boolean {
        val lowerMessage = message.lowercase()
        if (lowerMessage.contains("debit card purchase")) {
            return true
        }
